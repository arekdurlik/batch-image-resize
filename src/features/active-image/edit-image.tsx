  ...
  return (
    <Details>
      <Header>
        ...
        <ButtonGroup>
          <Button style={{ flex: 1 }} onClick={handleApply}><MdCheck/>Apply</Button>
          <Button style={{ flex: 1 }} onClick={handleClose}><MdClose/></Button>
        </ButtonGroup>
      </Header>
      ...
      <Sharpening
        ...
        onThresholdChange={v => handleChange(() => api.setSharpenThreshold(image.id, v, false))}
